...
#'
#' \tabular{ll}{
#'   \code{arg} \tab Regressor in the regression whose coefficient is constrained to be 1 \cr
#' }
#' }
#'
...
#' that separates different regimes.
#' \preformatted{
...
#'   For example, threshold \code{gamma(1)} is above \code{gamma(2)} and so on.
